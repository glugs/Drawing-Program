...
int sky=0xffE3FAF8;
//
public void buttomTemplateDraw() {
...
//
public void buttonTemplatemousePressed() {
  if (mouseX>=templateButtonX && mouseX<=templateButtonX+templateButtonWidth && mouseY>=templateButtonY && mouseY<=templateButtonY+templateButtonHeight) {
...
//
public void buttonBackgroundDraw () {
...
//
public void buttonShapemousePressed() {
  if (mouseX>=ShapeButtonX && mouseX<=ShapeButtonX+ShapeButtonWidth && mouseY>=ShapeButtonY && mouseY<=ShapeButtonY+ShapeButtonHeight) {
...
public void ShapeDraw() {
  ...
  //Title
  rect(shapeTX, shapeTY, shapeTWidth, shapeTHeight);
  fill(black); //Ink
  textAlign (CENTER, CENTER);
  size = 50;
  textFont(font, size);
  text(shapeTitle, shapeTX, shapeTY, shapeTWidth, shapeTHeight);
  fill(resetWhite);
  //
